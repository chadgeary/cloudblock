...
cd playbooks/
# Execute playbook
ansible-playbook cloudoffice_oci.yml --extra-vars 'docker_network=${docker_network} docker_gw=${docker_gw} docker_nextcloud=${docker_nextcloud} docker_db=${docker_db} docker_webproxy=${docker_webproxy} docker_onlyoffice=${docker_onlyoffice} admin_password_cipher=${admin_password_cipher} db_password_cipher=${db_password_cipher} oo_password_cipher=${oo_password_cipher} oci_kms_endpoint=${oci_kms_endpoint} oci_kms_keyid=${oci_kms_keyid} oci_storage_namespace=${oci_storage_namespace} oci_storage_bucketname=${oci_storage_bucketname} oci_region=${oci_region} oci_root_compartment=${oci_root_compartment} bucket_user_key_cipher=${bucket_user_key_cipher} bucket_user_id=${bucket_user_id} web_port=${web_port} oo_port=${oo_port} project_directory=${project_directory}' >> /var/log/cloudoffice.log
EOM
