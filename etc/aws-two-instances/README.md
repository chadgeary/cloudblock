# Reference
A special version of the terraform and ansible code to showcase deployment of two cloudblock instances side-by-side in AWS.
...
cd ~/cloudblock/etc/aws-two-instances/

# Open File Explorer in a separate window
# Navigate to aws project directory - change \chad\ to your WSL username
%HOMEPATH%\ubuntu-2204\rootfs\home\chad\cloudblock\aws
