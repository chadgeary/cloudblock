output "cloudblock-output" {
  ...
  ssh ubuntu@${oci_core_instance.ph-instance2.public_ip}
  (ssh ubuntu@${var.docker_gw})
  ...
  https://${oci_core_instance.ph-instance2.public_ip}/admin/
  (https://${var.docker_webproxy}/admin/)
  ...
  https://console.${var.oci_region}.oraclecloud.com/object-storage/buckets/${data.oci_objectstorage_namespace.ph-bucket-namespace.namespace}/${var.ph_prefix}-bucket2/objects
